...
AutoResetEventPipe::AutoResetEventPipe(QObject *parent)
        : QObject{
              parent,
          },
          m_notifier{
...
AutoResetEventPipe::~AutoResetEventPipe()
{
    if (m_fdConsumer != -1) {
...
#include "moc_AutoResetEventPipe_p.cpp"
