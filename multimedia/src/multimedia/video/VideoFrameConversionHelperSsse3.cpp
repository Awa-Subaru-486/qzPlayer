...
void convert_to_ARGB32_ssse3(const VideoFrame &frame, uchar *output)
{
...
void QT_FASTCALL qt_convert_ARGB8888_to_ARGB32_ssse3(const VideoFrame &frame, uchar *output)
{
    convert_to_ARGB32_ssse3<0, 1, 2, 3>(frame, output);
}

void QT_FASTCALL qt_convert_ABGR8888_to_ARGB32_ssse3(const VideoFrame &frame, uchar *output)
{
    convert_to_ARGB32_ssse3<0, 3, 2, 1>(frame, output);
}

void QT_FASTCALL qt_convert_RGBA8888_to_ARGB32_ssse3(const VideoFrame &frame, uchar *output)
{
    convert_to_ARGB32_ssse3<3, 0, 1, 2>(frame, output);
}

void QT_FASTCALL qt_convert_BGRA8888_to_ARGB32_ssse3(const VideoFrame &frame, uchar *output)
{
