...
namespace QWK {
    ...
    protected:
        ...
        QRect m_normalWindowRect;
        LONG m_normalWindowStyle = 0;
        qreal m_preMiniAspectRatio = 0.0;
        bool m_isMiniMode = false;
        bool m_autoMiniMode = false;
        bool m_autoExitMiniMode = false;

        int m_miniModeThresholdWidth = 0;
        int m_miniModeThresholdHeight = 0;
        qreal m_miniModeAspectRatio = 16.0 / 9.0;

        static constexpr int kMiniModeFixedSize = 320;
    };
